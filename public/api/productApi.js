...
function getCard(item){
    return `"<div class="col-lg-4 col-md-12 mb-4 mb-lg-0"><img src="data:image/jpeg;base64,${item.image}" class="w-100 shadow-1-strong rounded mb-4" alt="" /><li style="list-style-type:none;">${item.title}</li><li style="list-style-type:none;">${item.type}</li><li style="list-style-type:none;">${item.price}</li></div>"`
}